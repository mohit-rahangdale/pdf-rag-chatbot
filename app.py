...
def process_documents(files):
    ...
    try:
        ...
        return vector_store, gr.update(
            value="Documents processed successfully! You can now ask questions.",
            visible=True,
        )
...
def user_interaction(user_input, chat_history, vector_store):
    ...
    if vector_store is None:
        ...
        chat_history.append({"role": "assistant", "content": "Please process your documents first."})
        return "", chat_history
    ...
    # Add the users message and the bot's response to the history
